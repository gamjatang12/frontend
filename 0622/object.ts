...
// 값의 속성에 접근하려면 value.멤버 또는 val['멤버'] 구문 사용
...
// poetLater = "JeongBin"; //'string' 형식은 '{ born: number; name: string; }' 형식에 할당할 수 없습니다.
...
// 덕 타이핑: 동적 타이밍의 한 종류로 객체의 변수 및 메서드의 집합이 객체의 나이을 결정하는 것을 의미합니다.
